package com.example.mylogin_signin.DataBase;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "( " + ID + " INTEGER PRIMARY KEY  AUTOINCREMENT, " + NAME + " VARCHAR(100)," + GENDER + " TEXT(6) NOT NULL," + EMAIL + " TEXT(100) NOT NULL, " + BIRTHDAY + " TEXT(8)  NOT NULL, " + PHONE_NUMBER + " TEXT(100) NOT NULL, " + PASSWORD + " TEXT(100) NOT NULL )";
